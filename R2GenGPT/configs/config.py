...
parser.add_argument("--training_stage",type=str,default="teacher",help='The training stage to use (e.g. teacher, student)')
parser.add_argument("--use_mblora",  action="store_true", help="启用多分支 LoRA")
parser.add_argument("--num_lora_branches", type=int, default=2)
parser.add_argument("--active_lora_branch", type=int, default=0, help="本次 run 要训练 / 推理的 LoRA 分支索引")
