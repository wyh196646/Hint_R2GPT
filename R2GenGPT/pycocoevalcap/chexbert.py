...
class CheXbert(nn.Module):
    def __init__(self, checkpoint_path, device, p=0.1):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/home/ltf/code/data/bert-base-uncased')
        config = BertConfig().from_pretrained('/home/ltf/code/data/bert-base-uncased')
