...
parser.add_argument('--annotation', type=str, default=r'/data/wyh21/physionet.org/physionet.org/files/mimic-cxr-jpg/2.0.0/mimic_annotation_all.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'/data/wyh21/physionet.org/physionet.org/files/mimic-cxr-jpg/2.0.0/files', help="base dir to help find images")
...
parser.add_argument('--llama_model', default='mistralai/Mistral-7B-Instruct-v0.2', type=str, help="LLM model to use")
...
parser.add_argument('--pretrain_max_epochs', type=int, default=50, help='Stop training once this number of epochs is reached')
parser.add_argument('--pretrain_batch', type=int, default=512, help='how many gpus to use')
