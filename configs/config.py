...
parser.add_argument('--accumulate_grad_batches', type=int, default=2, help='Accumulates gradients over k batches before stepping the optimizer')
...
parser.add_argument('--devices', nargs='+',type=int,default= 0, help='<Required> Set flag', required=True)
# ====================== Pretraining ===========================
parser.add_argument('--embed_dim', type=int, default=1024, help='how many gpus to use')
parser.add_argument('--text_model', default='/data/wyh21/huggingface/models--emilyalsentzer--Bio_ClinicalBERT', type=str, help="text model to use")
...
parser.add_argument('--token_dim', type=int, default=768, help='token dim of clue get from bert')
parser.add_argument('--num_head', type=int, default=8)
#num_query_tokens
parser.add_argument('--num_query_tokens', type=int, default=48)
